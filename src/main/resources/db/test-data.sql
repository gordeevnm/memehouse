...
INSERT INTO meme (id, upload_time, attachment_id, description, name, created_by, is_public)
VALUES
	(1, current_timestamp, 1, 'Чувак с тыквой на голове танцует.', 'Ни ху я', 1, TRUE),
